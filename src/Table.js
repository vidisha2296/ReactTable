...
function Table({ columns, data }) {
  ...
  const handleDelete = () =>{
    ...
    axios.delete(`https://639c40a916d1763ab143ea54.mockapi.io/api/v1/members/${Id}`)
            .then(res => {
  ...
  return (
    ...
    {show ? (
      ...
      {/* table */}
      <div className="mt-4 flex flex-col scroll-smooth ">
                    ...
                    >
                        ...
                        {data.teams.map((i) => {
                          return (
                            <div class= "mx-4 space-y-4">
                              <div class=" bg-green-200  rounded-full py-2 px-4 ">
                                <p class="text-green-700 p-2">{i}</p>
                              </div>
                            </div>
                          );
                        })}
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div   class="flex m-2 space-x-4">
                          <button onClick={()=>handleClick(data.id)}  data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                          <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          viewBox="0 0 24 24"
